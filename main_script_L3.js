// Get reference to the tbody (table body) element
...
/* This line of code binds dataTables sorting and paging functionalities to
 *   the table 'myTable'.
 * Searching is disabled since it does not interoperate well with my own search.
 * Page lengths are set to smaller values to work better with a smaller data set.
 * 
 * As mentioned in the README, pagination does not work properly with search:
 *   search results are displayed in one page (without any pagination) and the
 *   footer info and paging navigation buttons are completely incorrect.
 */
